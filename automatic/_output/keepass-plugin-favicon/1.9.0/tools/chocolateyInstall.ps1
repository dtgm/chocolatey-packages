$packageName = 'keepass-plugin-favicon'
$packageSearch = 'KeePass Password Safe'
$url = 'http://sourceforge.net/projects/keepass-favicon/files/1.9.0/KeePassFaviconDownloader.plgx/download'
$checksum = '595fe8aa10f72b6670be00f04aff4733d6de61d2'
$checksumType = 'sha1'
try {
