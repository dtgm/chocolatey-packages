...
$url1 = Get-FilenameFromRegex 'http://www.filehippo.com/download_shockwave/history/' 'download_shockwave/([\d]+)/">Shockwave 12.1.7.157<' 'http://www.filehippo.com/download_shockwave/$1/'
