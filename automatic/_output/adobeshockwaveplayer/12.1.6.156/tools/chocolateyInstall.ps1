...
$installerType = 'exe'
$checksum = 'c0b66e96963fcec3b3fac370a39bf73a7cc1a5fd'
$checksumType = 'sha1'
$silentArgs = '/S /NCRC'
...
$url1 = Get-FilenameFromRegex 'http://www.filehippo.com/download_shockwave/history/' 'download_shockwave/([\d]+)/"[^\d]+\s+12.1.6.156<' 'http://www.filehippo.com/download_shockwave/$1/'
