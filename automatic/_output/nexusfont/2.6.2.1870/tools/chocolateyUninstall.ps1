...
if (Test-Path -PathType Container (Join-Path $chocoLib 'nexusfont.*')) {
...
"@
  Write-Warning "To finish removing the program installed by package nexusfont, please also run the command:"
