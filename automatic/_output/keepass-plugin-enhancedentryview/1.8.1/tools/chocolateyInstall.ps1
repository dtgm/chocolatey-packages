...
$url = 'https://sourceforge.net/projects/kpenhentryview/files/v1.8.1/KPEnhancedEntryView-v1.8.1.zip'
$checksum = '3c013a5046d3c200a31bf94b11ee230788c457fa40954eacad41bca7bf566f64'
$checksumType = 'sha256'
