...
$url = 'https://sourceforge.net/projects/kpenhentryview/files/v1.9.1/KPEnhancedEntryView-v1.9.1.zip'
$checksum = '5b335615df1b3074b50e634fb87154c667d71f7e99fdce282bb3754a5776d707'
$checksumType = 'sha256'
