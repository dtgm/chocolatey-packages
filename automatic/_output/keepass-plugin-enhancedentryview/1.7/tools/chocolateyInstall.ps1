...
$url = 'https://sourceforge.net/projects/kpenhentryview/files/v1.7/KPEnhancedEntryView-v1.7.zip'
$checksum = '2e577897badf6bfe24c0a5bec2032a23ef34964357336edc0325e25fa1a55eca'
$checksumType = 'sha256'
