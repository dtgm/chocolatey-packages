...
$url = 'https://sourceforge.net/projects/kpenhentryview/files/v1.8/KPEnhancedEntryView-v1.8.zip'
$checksum = '8f5c622f0810807e2dfb419d4ec03f47911a48a5e1d3a0e87ebb6af9ca002105'
$checksumType = 'sha256'
