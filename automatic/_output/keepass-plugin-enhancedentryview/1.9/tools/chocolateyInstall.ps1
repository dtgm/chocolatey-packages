...
$url = 'https://sourceforge.net/projects/kpenhentryview/files/v1.9/KPEnhancedEntryView-v1.9.zip'
$checksum = '23bce136d8b0ceabb7d506bb41c1f89271152a923c69a13e00afca367baa64de'
$checksumType = 'sha256'
