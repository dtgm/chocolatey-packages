$packageName = 'mariadb'
$urlArray = @('https://downloads.mariadb.org//f/mariadb-10.1.19/win32-packages/mariadb-10.1.19-win32.msi','https://downloads.mariadb.org//f/mariadb-10.1.19/winx64-packages/mariadb-10.1.19-winx64.msi')
$url = $urlArray[0]
$checksum = '{checksum}'
$checksumType = 'sha256'
$url64 = $urlArray[1]
