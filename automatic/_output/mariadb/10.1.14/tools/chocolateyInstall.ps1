$packageName = 'mariadb'
$urlArray = @('https://downloads.mariadb.org//f/mariadb-10.1.14/win32-packages/mariadb-10.1.14-win32.msi','https://downloads.mariadb.org//f/mariadb-10.1.14/winx64-packages/mariadb-10.1.14-winx64.msi')
$url = $urlArray[0]
$checksum = '56d85fa08ea6276553709db2b7cddc6fe14f309b'
$checksumType = 'sha1'
$url64 = $urlArray[1]
$checksum64 = '74c6a7e3c51515854dee8e268dcbe27013255a26'
$checksumType64 = 'sha1'
$installerType = 'msi'
