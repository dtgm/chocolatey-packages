$packageName = 'mariadb'
$urlArray = @('https://downloads.mariadb.org//f/mariadb-10.1.8/win32-packages/mariadb-10.1.8-win32.msi','https://downloads.mariadb.org//f/mariadb-10.1.8/winx64-packages/mariadb-10.1.8-winx64.msi')
$url = $urlArray[0]
$checksum = '7a0fbce8d165edace6df2853651df3ade4882b71'
$checksumType = 'sha1'
$url64 = $urlArray[1]
$checksum64 = '15730de685b7d25fd5e453ddef72abbda235ad3d'
$checksumType64 = 'sha1'
$installerType = 'msi'
