$packageName = 'mariadb'
$urlArray = @('https://downloads.mariadb.org//f/mariadb-10.1.15/win32-packages/mariadb-10.1.15-win32.msi','https://downloads.mariadb.org//f/mariadb-10.1.15/winx64-packages/mariadb-10.1.15-winx64.msi')
$url = $urlArray[0]
$checksum = 'a20517bbc1ea8c6d43f6847c8addd0712b596bf6791fb9aaa0145d4be865ee9b'
$checksumType = 'sha256'
$url64 = $urlArray[1]
$checksum64 = '057bebf7672edecfd15d6566ee821a8e139ddfd439486555f060189aa07275b7'
