...
$packageName = 'mongodb'
$version = '3.2.5'
$url = 'http://downloads.mongodb.org/win32/mongodb-win32-i386-3.2.5.zip'
$checksum = '45f67939f0e564335a2b8dbff564f71aeac0f744'
$checksumType = 'sha1'
$url64 = 'http://downloads.mongodb.org/win32/mongodb-win32-x86_64-3.2.5.zip'
$checksum64 = '7faf4a10817e97f22b1ccc47cc2ddaef120bbe98'
$checksumType64 = 'sha1'
