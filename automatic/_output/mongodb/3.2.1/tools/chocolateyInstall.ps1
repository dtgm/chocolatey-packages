...
$packageName = 'mongodb'
$version = '3.2.1'
$url = 'http://downloads.mongodb.org/win32/mongodb-win32-i386-3.2.1.zip'
$checksum = '277f054de10342bba315e8049748df21d730904a'
$checksumType = 'sha1'
$url64 = 'http://downloads.mongodb.org/win32/mongodb-win32-x86_64-3.2.1.zip'
$checksum64 = '6ffc076b7f1ba3a5612fd5283ce6a2ea5406acb4'
$checksumType64 = 'sha1'
