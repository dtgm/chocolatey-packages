...
$packageSearch = 'WinSCP 5.7.5'
$packageVersion = '5.7.5'
$versionShort = ($packageVersion).Replace(".","")
$url = 'http://sourceforge.net/projects/winscp/files/WinSCP/5.7.5/winscp575setup.exe/download'
$checksum = 'a1a329444b5a6929ef1675019644caab14b1a728'
$checksumType = 'sha1'
$validExitCodes = @(0)
