...
$packageSearch = 'WinSCP 5.9.6'
$packageVersion = '5.9.6'
$softwareVersion = $packageVersion
$url = 'https://sourceforge.net/projects/winscp/files/WinSCP/5.9.6/WinSCP-5.9.6-Setup.exe/download'
$checksum = 'db1053d9f136302607738487621f77f577ac0a642482d0dad87508795ea94e7f'
$checksumType = 'sha256'
$validExitCodes = @(0)
