...
$packageSearch = 'WinSCP 5.7.7'
$packageVersion = '5.7.7'
$versionShort = ($packageVersion).Replace(".","")
$url = 'https://sourceforge.net/projects/winscp/files/WinSCP/5.7.7/winscp577setup.exe/download'
$checksum = '3bd86664777f958e326ec155878239f905a923e0'
$checksumType = 'sha1'
$validExitCodes = @(0)
