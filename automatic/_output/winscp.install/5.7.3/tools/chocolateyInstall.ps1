...
$packageSearch = 'WinSCP 5.7.3'
$packageVersion = '5.7.3'
$versionShort = ($packageVersion).Replace(".","")
$url = 'http://sourceforge.net/projects/winscp/files/WinSCP/5.7.3/winscp573setup.exe/download'
$checksum = '3cf13ac4d98fe7d29c63be8345c058a16104e3a0'
$checksumType = 'sha1'
$validExitCodes = @(0)
