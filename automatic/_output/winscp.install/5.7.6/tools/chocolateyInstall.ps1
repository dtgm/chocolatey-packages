...
$packageSearch = 'WinSCP 5.7.6'
$packageVersion = '5.7.6'
$versionShort = ($packageVersion).Replace(".","")
$url = 'http://sourceforge.net/projects/winscp/files/WinSCP/5.7.6/winscp576setup.exe/download'
$checksum = '8fc0a68420eb5f12cd82121e8247888d03d09d2d'
$checksumType = 'sha1'
$validExitCodes = @(0)
