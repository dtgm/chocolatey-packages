...
$packageSearch = 'WinSCP 5.7.4'
$packageVersion = '5.7.4'
$versionShort = ($packageVersion).Replace(".","")
$url = 'http://sourceforge.net/projects/winscp/files/WinSCP/5.7.4/winscp574setup.exe/download'
$checksum = 'c095ad394981110a3b49db0a9421635e32df8ee0'
$checksumType = 'sha1'
$validExitCodes = @(0)
