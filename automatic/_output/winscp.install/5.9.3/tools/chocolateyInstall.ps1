...
$packageSearch = 'WinSCP 5.9.3'
$packageVersion = '5.9.3'
$versionShort = ($packageVersion).Replace(".","")
$url = 'https://sourceforge.net/projects/winscp/files/WinSCP/5.9.3/WinSCP-5.9.3-Setup.exe'
$checksum = 'ef1a99b3ffc7f9e09627f096b3e4131226885299'
$checksumType = 'sha1'
$validExitCodes = @(0)
