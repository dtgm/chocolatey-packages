...
if (Test-Path -PathType Container (Join-Path $chocoLib 'nsis.*')) {
...
"@
  Write-Warning "To finish removing the program installed by package nsis, please also run the command:"
