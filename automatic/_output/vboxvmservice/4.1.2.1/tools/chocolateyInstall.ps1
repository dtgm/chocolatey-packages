...
$packageName = 'VBoxVmService' # arbitrary name for the package, used in messages
$installerType = 'EXE' #only one of these: exe, msi, msu
$url = 'http://sourceforge.net/projects/vboxvmservice/files/vboxvmservice/Versions%204.x/VBoxVmService-4.1-Ginger.exe/download?use_mirror=tenet' # download url
