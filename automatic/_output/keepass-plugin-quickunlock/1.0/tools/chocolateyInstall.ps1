...
$packageName = 'keepass-plugin-quickunlock'
$packageSearch = 'KeePass Password Safe'
$url = 'https://github.com/KN4CK3R/KeePassQuickUnlock/releases/download/1.0/KeePassQuickUnlock.plgx'
$checksum = '6d9ab685aa596ab5bb9248f6d8ec8c624cc1e5e77db5308f4c5dc1ac0f32e7a2'
$checksumType = 'sha256'
