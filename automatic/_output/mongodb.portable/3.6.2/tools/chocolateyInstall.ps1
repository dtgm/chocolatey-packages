...
$version = '3.6.2'
$url = 'https://downloads.mongodb.org/win32/mongodb-win32-x86_64-2008plus-ssl-3.6.2.zip'
$checksum = '32c00a2a11ea1ee58b41818cf5e1d07055dd763b1cdaab740c79ddaaca33a2cd'
$checksumType = 'sha256'
