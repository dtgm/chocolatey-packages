...
$version = '3.6.0'
$url = 'https://downloads.mongodb.org/win32/mongodb-win32-x86_64-2008plus-ssl-3.6.0.zip'
$checksum = 'be83963ca2a1e2237f5c42a64c82889aa46bf0f09dd818a229d3b8da8601d530'
$checksumType = 'sha256'
