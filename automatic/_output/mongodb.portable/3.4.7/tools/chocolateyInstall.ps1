...
$version = '3.4.7'
$url = 'https://downloads.mongodb.org/win32/mongodb-win32-x86_64-2008plus-ssl-3.4.7.zip'
$checksum = 'ac44602c01b9873f02f77b4777d3b8b35ef1a97656fdddbbd58a960d0712d10e'
$checksumType = 'sha256'
