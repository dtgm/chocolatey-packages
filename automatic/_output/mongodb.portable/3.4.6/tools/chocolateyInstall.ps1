...
$version = '3.4.6'
$url = 'https://downloads.mongodb.org/win32/mongodb-win32-x86_64-2008plus-ssl-3.4.6.zip'
$checksum = 'e236e09268133e4c71eaf5c41d5408f075d2565c5f685cf0631e860f4921e7d7'
$checksumType = 'sha256'
