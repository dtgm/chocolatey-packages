...
$version = '3.4.9'
$url = 'https://downloads.mongodb.org/win32/mongodb-win32-x86_64-2008plus-ssl-3.4.9.zip'
$checksum = '85bce632a740bb8ccd014ed0841406f0baf779be9057c054408de90dc14f6c81'
$checksumType = 'sha256'
