$packageName = 'ddu'
$url = 'http://www.wagnardmobile.com/DDU/download/DDU v15.3.0.3.exe'
$checksum = '4b7d52bae57bec8fc69568ff734272472e58c7b9'
$checksumType = 'sha1'
...
$referer = "http://www.wagnardmobile.com/DDU/ddudownload.htm"
