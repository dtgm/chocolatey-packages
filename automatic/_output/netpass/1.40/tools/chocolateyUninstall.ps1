...
if (Test-Path -PathType Container (Join-Path $chocoLib 'netpass.*')) {
...
"@
  Write-Warning "To finish removing the program installed by package netpass, please also run the command:"
