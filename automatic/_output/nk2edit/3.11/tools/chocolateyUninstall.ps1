...
if (Test-Path -PathType Container (Join-Path $chocoLib 'nk2edit.*')) {
...
"@
  Write-Warning "To finish removing the program installed by package nk2edit, please also run the command:"
