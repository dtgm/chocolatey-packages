...
$url = 'http://sourceforge.net/projects/freeplane/files/freeplane%20stable/archive/1.6.6/Freeplane-Setup-1.6.6.exe/download'
$silentArgs = '/VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-'
$validExitCodes = @(0)  #please insert other valid exit codes here, exit codes for ms http://msdn.microsoft.com/en-us/library/aa368542(VS.85).aspx
$checksum = 'aaae2fa04c21ace71154b7b2708893e722707e9afff07315f5d68339f7377e2d'
$checksumType = 'sha256'
