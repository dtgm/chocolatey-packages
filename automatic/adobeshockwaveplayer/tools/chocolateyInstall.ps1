...
$url1 = Get-FilenameFromRegex 'http://www.filehippo.com/download_shockwave/history/' 'download_shockwave/([\d]+)/">Shockwave {{PackageVersion}}<' 'http://www.filehippo.com/download_shockwave/$1/'
