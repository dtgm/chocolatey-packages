...
$url1 = Get-FilenameFromRegex 'http://www.filehippo.com/download_shockwave/history/' 'download_shockwave/([\d]+)/"[^\d]+\s+{{PackageVersion}}<' 'http://www.filehippo.com/download_shockwave/$1/'
